...
use GajdaW\ExampleMenuBundle\Form\MenuType;
...
class MenuController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GajdaWExampleMenuBundle:Menu')->findAll();
     ...
     * @Method("POST")
     * @Template("GajdaWExampleMenuBundle:Menu:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GajdaWExampleMenuBundle:Menu')->find($id);
     ...
     * @Method("PUT")
     * @Template("GajdaWExampleMenuBundle:Menu:edit.html.twig")
     */
